    ...
    <div class="container">
      <div class="footer__inner">
        <div class="footer__contacts">
          <div class="footer__contacts__phone-number__box">
            <div class="footer__contacts__phone-number">
              <span class="footer__contacts__phone-number-item">+7 800 555-10-61</span>
            </div>
            <div class="footer__contacts__phone-number">
              <span class="footer__contacts__phone-number-item">+7 495 649-83-14</span>
            </div>
          </div>
          <div class="footer__contacts__adress">
            г. Киев, ул. Политехническая, д. 18, стр. 11
          </div>
        </div>
        <div class="footer__logo">
          <a href="#" class="footer__logo-link">
            <img src="@/assets/images/logo.svg" alt="NEWTONE" class="footer__logo-img" />
          </a>
        </div>
