          ...
          <div class="product-page__content-box">
            ...
            <div class="product-page__info">
              <p class="product-page__info-text">
                ...
                laboriosam, illum autem accusamus, aliquid suscipit fugit
                commodi officiis provident eveniet dicta necessitatibus
                quisquam! Ab repudiandae adipisci est voluptates consequuntur
                praesentium?
              </p>
              <p class="product-page__info-text">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quidem
                quas nisi sint illum soluta tempore esse rerum. Dicta ut, neque
                harum hic nam quibusdam. Esse, necessitatibus cumque. Beatae,
                repudiandae rem! Lorem ipsum dolor sit, amet consectetur
                adipisicing elit. Vero laboriosam, illum autem accusamus,
                aliquid suscipit fugit commodi officiis provident eveniet dicta
                necessitatibus quisquam! Ab repudiandae adipisci est voluptates
